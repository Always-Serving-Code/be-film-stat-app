...
describe("/api/users/:user_id", () => {
    test("PATCH 200 /api/users/:user_id - responds with an object with an updated user after adding a film", () => __awaiter(void 0, void 0, void 0, function* () {
        const film = {
            _id: 1,
    ...
    test("PATCH 200 /api/users/:user_id - responds with an object with an updated user with number of films not 0 after adding a film", () => __awaiter(void 0, void 0, void 0, function* () {
        const film = {
            _id: 1,
            title: "The Lord of The Rings: The Fellowship of the Ring",
            directors: ["Peter Jackson"],
        ...
        expect(user).toMatchObject({
            ...
            films: [
                ...
                },
                {
                    ...
                    poster_url: "https://artofthemovies.co.uk/cdn/shop/products/lord_of_the_rings_the_two_towers_NG06275_B_2_framed1-423634.jpg?v=1611688137",
                    lead_actors: ["Elijah Wood", "Ian McKellen", "Viggo Mortensen"],
                    runtime: 235,
                    rating: 5,
                    date_watched: expect.any(String),
                },
                {
                    ...
                    poster_url: "https://static.posters.cz/image/1300/posters/the-lord-of-the-rings-the-return-of-the-king-i104633.jpg",
                    lead_actors: ["Elijah Wood", "Ian McKellen", "Viggo Mortensen"],
                    runtime: 201,
                    rating: 5,
                    date_watched: expect.any(String),
                },
                {
                    ...
                    release_year: 2019,
                    synopsis: "A couple travels to Northern Europe to visit a rural hometown's fabled Swedish mid-summer festival. What begins as an idyllic retreat quickly devolves into an increasingly violent and bizarre competition at the hands of a pagan cult.",
                    poster_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKk36ZSsCK9NVLN-H10vITUFK33gfpBeYenRQ8wF3sww&s",
    ...
    test("PATCH 400 /api/users/:user_id - user id is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
        const film = {
            _id: 1,
            title: "The Lord of The Rings: The Fellowship of the Ring",
            directors: "Peter Jackson",
    ...
    test("PATCH 404 /api/users/:user_id - user id is not found", () => __awaiter(void 0, void 0, void 0, function* () {
        const film = {
            _id: 1,
            title: "The Lord of The Rings: The Fellowship of the Ring",
            directors: "Peter Jackson",
